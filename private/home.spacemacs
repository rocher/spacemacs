...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ac-ispell ace-jump-helm-line ace-link ace-window ada-ref-man adaptive-wrap aggressive-indent alert anaconda-mode auctex auto-compile auto-complete auto-dictionary auto-highlight-symbol auto-yasnippet bm buffer-move calfw clang-format clean-aindent-mode cmake-mode coffee-mode column-enforce-mode company company-anaconda company-auctex company-c-headers company-dcd company-restclient company-shell company-statistics company-tern company-web csv-mode cython-mode d-mode dash-functional datetime define-word diff-hl disaster drupal-mode dumb-jump dynamic-ruler elf-mode elisp-slime-nav emmet-mode engine-mode erlang esh-help eshell-prompt-extras eshell-z eval-sexp-fu evil-anzu evil-args evil-ediff evil-escape evil-exchange evil-iedit-state evil-indent-plus evil-lisp-state evil-magit evil-matchit evil-mc evil-nerd-commenter evil-numbers evil-search-highlight-persist evil-surround evil-tutor evil-unimpaired evil-visual-mark-mode evil-visualstar exec-path-from-shell expand-region eyebrowse fancy-battery fill-column-indicator fish-mode flx-ido flycheck flycheck-dmd-dub flycheck-package flycheck-pos-tip flyspell-correct flyspell-correct-helm fringe-helper fuzzy geben geben-helm-projectile gh gh-md gist git-commit git-gutter git-gutter+ git-gutter-fringe git-gutter-fringe+ git-link git-messenger git-timemachine gitattributes-mode gitconfig-mode github-browse-file github-clone github-search gitignore-mode gntp gnuplot golden-ratio google-translate gotham-theme haml-mode helm-ag helm-c-yasnippet helm-company helm-css-scss helm-dash helm-descbinds helm-flx helm-gitignore helm-make helm-mode-manager helm-projectile helm-pydoc helm-swoop helm-themes helm-youtube help-fns+ hide-comnt highlight-indentation highlight-numbers highlight-parentheses hl-todo ht htmlize hungry-delete hy-mode indent-guide info+ insert-shebang ivy js-doc js2-mode js2-refactor json-mode json-reformat json-snatcher kanban know-your-http-well less-css-mode link-hint linum-relative live-py-mode livid-mode log4e logito logview lorem-ipsum macrostep magit magit-gh-pulls magit-gitflow magit-popup markdown-mode markdown-toc marshal mmm-mode move-text multi-term multiple-cursors neotree ob-http ob-restclient olivetti open-junk-file org-bullets org-category-capture org-download org-plus-contrib org-pomodoro org-present org-projectile orgit ox-pandoc ox-reveal ox-twbs package-lint pandoc-mode paradox pcache pcre2el persp-fr persp-mode php-auto-yasnippets php-extras php-mode phpcbf phpunit pip-requirements plantuml-mode popwin pos-tip psvn pug-mode py-isort pyenv-mode pytest pythonic pyvenv rainbow-delimiters ranger request restart-emacs restclient restclient-helm sass-mode scss-mode shell-pop simple-httpd skewer-mode slim-mode smeargle spaceline sql-indent sx systemd tagedit tern textile-mode toc-org use-package uuidgen vi-tilde-fringe volatile-highlights web-beautify web-completion-data web-mode which-key winum with-editor ws-butler xkcd xterm-color yapfify yasnippet zeal-at-point ztree)))
