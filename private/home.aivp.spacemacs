...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-startup-banner "/home/galileo/.work-as.png"
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ac-ispell ace-jump-helm-line ace-link ace-window adaptive-wrap aggressive-indent auto-compile auto-complete-rst auto-dictionary auto-highlight-symbol auto-yasnippet bm browse-at-remote buffer-move clean-aindent-mode coffee-mode column-enforce-mode company-anaconda company-php company-restclient company-shell company-statistics company-tern company-web cython-mode define-word diff-hl drupal-mode dumb-jump dynamic-ruler editorconfig elisp-slime-nav emmet-mode engine-mode esh-help eshell-prompt-extras eshell-z eval-sexp-fu evil-anzu evil-args evil-ediff evil-exchange evil-iedit-state evil-indent-plus evil-lion evil-lisp-state evil-magit evil-matchit evil-mc evil-nerd-commenter evil-numbers evil-org evil-search-highlight-persist evil-surround evil-tutor evil-unimpaired evil-visual-mark-mode evil-visualstar exec-path-from-shell expand-region eyebrowse fancy-battery fill-column-indicator fish-mode flx-ido flycheck-bashate flycheck-pos-tip flyspell-correct-helm fuzzy gh-md gist git-gutter-fringe git-gutter-fringe+ git-link git-messenger git-timemachine gitattributes-mode gitconfig-mode github-clone github-search gnuplot golden-ratio google-translate gotham-theme helm-ag helm-c-yasnippet helm-company helm-css-scss helm-descbinds helm-flx helm-gitignore helm-make helm-mode-manager helm-projectile helm-purpose helm-pydoc helm-swoop helm-themes help-fns+ hide-comnt highlight-indentation highlight-numbers highlight-parentheses hl-todo hungry-delete hy-mode impatient-mode indent-guide info+ insert-shebang js-doc js2-refactor json-mode link-hint linum-relative live-py-mode livid-mode lorem-ipsum macrostep magit-gh-pulls magit-gitflow markdown-toc mmm-mode move-text multi-term neotree ob-http ob-ipython ob-php ob-restclient ob-sql-mode open-junk-file org-brain org-bullets org-download org-pomodoro org-present org-projectile orgit ox-pandoc ox-reveal ox-twbs pandoc-mode paradox password-generator pcre2el pdf-tools persp-fr php-auto-yasnippets php-extras phpcbf phpunit pip-requirements po-mode pony-mode popwin pug-mode py-isort pyenv-mode pytest pyvenv rainbow-delimiters restart-emacs restclient-helm sass-mode scss-mode shell-pop slim-mode smeargle spaceline sql-indent string-inflection sx symon tagedit textile-mode toc-org use-package uuidgen vi-tilde-fringe volatile-highlights web-beautify web-mode which-key winum ws-butler xterm-color yapfify)))
